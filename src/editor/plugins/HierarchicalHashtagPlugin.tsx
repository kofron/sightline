...
function getHashtagRegexString(): string {
  ...
  const extendedAlphanumeric = alphanumeric + ":";
  const hashtagAlpha = "[" + alpha + "]";
  const hashtagAlphanumeric = "[" + extendedAlphanumeric + "]";
  const hashtagBoundary = "^|$|[^&/" + extendedAlphanumeric + "]";
...
export default function HierarchicalHashtagPlugin() {
  ...
  const createHashtagNode = useCallback(
    (textNode: TextNode) => $createHashtagNode(textNode.getTextContent()),
    [],
  );
